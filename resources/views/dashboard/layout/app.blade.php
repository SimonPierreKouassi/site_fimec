...
<head>
	...
	<!-- Theme JS files -->
	<script src="{{ Vite::asset('resources/assets_admin/js/vendor/visualization/d3/d3.min.js') }}"></script>
	<script src="{{ Vite::asset('resources/assets_admin/js/vendor/visualization/d3/d3_tooltip.js') }}"></script>

	
	<script src="{{ Vite::asset('resources/assets_admin/demo/pages/dashboard.js') }}"></script>
	<script src="{{ Vite::asset('resources/assets_admin/demo/charts/pages/dashboard/streamgraph.js') }}"></script>
	<script src="{{ Vite::asset('resources/assets_admin/demo/charts/pages/dashboard/sparklines.js') }}"></script>
	<script src="{{ Vite::asset('resources/assets_admin/demo/charts/pages/dashboard/lines.js') }}"></script>
	<script src="{{ Vite::asset('resources/assets_admin/demo/charts/pages/dashboard/areas.js') }}"></script>
	<script src="{{ Vite::asset('resources/assets_admin/demo/charts/pages/dashboard/donuts.js') }}	"></script>
	<script src="{{ Vite::asset('resources/assets_admin/demo/charts/pages/dashboard/bars.js') }}"></script>	
	<script src="{{ Vite::asset('resources/assets_admin/demo/charts/pages/dashboard/progress.js') }}"></script>
	<script src="{{ Vite::asset('resources/assets_admin/demo/charts/pages/dashboard/heatmaps.js') }}"></script>
	<script src="{{ Vite::asset('resources/assets_admin/demo/charts/pages/dashboard/pies.js') }}"></script>
	<script src="{{ Vite::asset('resources/assets_admin/demo/charts/pages/dashboard/bullets.js') }}"></script>
	<script src="{{ Vite::asset('resources/assets_admin/demo/pages/editor_ckeditor_classic.js') }}"></script>
	
	
	<script src="{{ Vite::asset('resources/assets_admin/js/vendor/forms/selects/select2.min.js') }}"></script>
		...
		<div class="container-fluid">
			...
			<div class="navbar-brand flex-1 flex-lg-0">
				<a href="index.html" class="d-inline-flex align-items-center">
					<img src="{{ Vite::asset('resources/assets_admin/images/logo_icon.svg') }}" alt="">
					<img src="{{ Vite::asset('resources/assets_admin/images/logo_text_light.svg') }}" class="d-none d-sm-inline-block h-16px ms-3" alt="">
				</a>
			</div>
						...
						<div class="dropdown-menu-scrollable pb-2">
							<a href="#" class="dropdown-item align-items-start text-wrap py-2">
								<div class="status-indicator-container me-3">
									<img src="{{ Vite::asset('resources/assets_admin/images/demo/users/face10.jpg') }}" class="w-40px h-40px rounded-pill" alt="">
							...
							<a href="#" class="dropdown-item align-items-start text-wrap py-2">
								<div class="status-indicator-container me-3">
									<img src="{{ Vite::asset('resources/assets_admin/images/demo/users/face3.jpg') }}" class="w-40px h-40px rounded-pill" alt="">
							...
							<a href="#" class="dropdown-item align-items-start text-wrap py-2">
								<div class="status-indicator-container me-3">
									<img src="{{ Vite::asset('resources/assets_admin/images/demo/users/face24.jpg') }}" class="w-40px h-40px rounded-pill" alt="">
									<span class="status-indicator bg-success"></span>
								</div>
								<div class="flex-1">
							...
							<a href="#" class="dropdown-item align-items-start text-wrap py-2">
								<div class="status-indicator-container me-3">
									<img src="{{ Vite::asset('resources/assets_admin/images/demo/users/face4.jpg') }}" class="w-40px h-40px rounded-pill" alt="">
							...
							<a href="#" class="dropdown-item align-items-start text-wrap py-2">
								<div class="status-indicator-container me-3">
									<img src="{{ Vite::asset('resources/assets_admin/images/demo/users/face25.jpg') }}" class="w-40px h-40px rounded-pill" alt="">
						...
						<div class="dropdown-menu w-100" data-color-theme="light">
							...
							<div class="dropdown-menu-scrollable-lg">
								...
								<div class="dropdown-item cursor-pointer">
									<div class="me-3">
										<img src="{{ Vite::asset('resources/assets_admin/images/demo/users/face3.jpg') }}" class="w-32px h-32px rounded-pill" alt="">
									</div>
								...
								<div class="dropdown-item cursor-pointer">
									<div class="me-3">
										<img src="{{ Vite::asset('resources/assets_admin/images/demo/users/face24.jpg') }}" class="w-32px h-32px rounded-pill" alt="">
									</div>
								...
								<div class="dropdown-item cursor-pointer">
									<div class="me-3">
										<img src="{{ Vite::asset('resources/assets_admin/images/brands/adobe.svg') }}" class="w-32px h-32px rounded-pill" alt="">
									</div>
								...
								<div class="dropdown-item cursor-pointer">
									<div class="me-3">
										<img src="{{ Vite::asset('resources/assets_admin/images/brands/holiday-inn.svg') }}" class="w-32px h-32px rounded-pill" alt="">
									</div>
								...
								<div class="dropdown-item cursor-pointer">
									<div class="me-3">
										<img src="{{ Vite::asset('resources/assets_admin/images/brands/ing.svg') }}" class="w-32px h-32px rounded-pill" alt="">
									</div>
