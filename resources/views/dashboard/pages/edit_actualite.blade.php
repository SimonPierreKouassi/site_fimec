...
@section('title', 'Modification d\'une actualité')
						...
						<div class="card-body border-top">
							<form action="{{ route('actualites.update', $actualite->id) }}" method="POST" enctype="multipart/form-data">
								...
								<div class="row mb-3">
									...
									<div class="col-lg-9">
										<input type="text" class="form-control" placeholder="Cérémonie de lancement du FIMEC 2026" name="titre" value="{{ old('titre', $actualite->titre) }}">
									</div>
								</div>
								<div class="row mb-3">
									<label class="col-lg-3 col-form-label">Catégories</label>
									<div class="col-lg-9">
										<select class="form-control form-control-select2" value="{{ old('categorie', $actualite->categorie) }}" name="categorie">
											<optgroup label="">
									...
									<div class="col-lg-9">
										<div class="form-check-horizontal">
											<label class="form-check form-check-inline">
												<input name="is_published" type="radio"  class="form-check-input" value="1" {{ old('is_published', $actualite->is_published) == 1 ? 'checked' : '' }}>
												<span class="form-check-label">Oui</span>
											</label>
											<label class="form-check form-check-inline">
												<input name="is_published" type="radio" class="form-check-input" value="0" {{ old('is_published', $actualite->is_published) == 0 ? 'checked' : '' }}>
                                ...
                                <div class="mb-3">
                                    ...
                                    @if($actualite->image)
                                        <div class="mb-2">
                                            <img src="{{ asset('storage/' . $actualite->image) }}" alt="Image actuelle" class="img-thumbnail" style="max-width: 200px;">
                                        </div>
                                    @else
								...
								<div class="row mb-3">
									...
									<div class="col-lg-9">
									<textarea class="form-control" id="ckeditor_classic_prefilled" name="contenu">{{ old('contenu', $actualite->contenu) }}</textarea>
									</textarea>									</div>
								</div>
