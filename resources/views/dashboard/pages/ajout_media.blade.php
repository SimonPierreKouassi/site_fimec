...
@section('title', 'Ajout d\'un media')
				...
				<div class="content">
					...
					<div class="card">
						<div class="card-header">
							<h5 class="mb-0">Ajout des photos</h5>
						</div>
						...
						<div class="card-body">
							...
							<form action="{{ route('ajout_medias.store') }}" method="POST" enctype="multipart/form-data">
								@csrf
								<div class="mb-3">
									<label class="form-label">Nom de la photo:</label>
									<input type="text" name="nom" class="form-control" placeholder="Plaquette FIMEC">
								</div>
                                <input type="text" name="type" value="photo" hidden >

								<div class="mb-3">
									<label class="form-label">Publié:</label>
									<div>
										<label class="form-check form-check-inline">
											<input type="radio" class="form-check-input" name="is_published" value="1" checked>
					...
					<div class="card">
						<div class="card-header">
							<h5 class="mb-0">Ajout des videos</h5>
						</div>
						...
						<div class="card-body">
							...
							<form action="{{ route('ajout_medias.store') }}" method="POST" enctype="multipart/form-data">
								...
								<div class="mb-3">
									...
									<input type="text" name="titre" class="form-control" placeholder="Plaquette FIMEC">
								</div>
                                ...
                                <div class="mb-3">
									...
									<input type="text" name="url" class="form-control" placeholder="https://www.youtube.com/watch?v=example">
								</div>
								<div class="mb-3">
