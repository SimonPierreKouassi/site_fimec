						...
						<div class="card-body border-top">
							<form action="{{ route('ajout_intervenants.store') }}" method="POST" enctype="multipart/form-data">
								...
								<div class="mb-3">
									...
									<input type="text" name="nom_intervenant" class="form-control" placeholder="Seka Eric">
								</div>

								<div class="mb-3">
									<label class="form-label"> Fonction:</label>
									<input type="text" name="fonction" class="form-control" placeholder="Charge de Communication">
								</div>
                                <div class="mb-3">
									<label class="form-label">Lien facebook:</label>
									<input type="text" name="facebook" class="form-control" placeholder="facebook.com/sekaeric">
								</div>
                                <div class="mb-3">
									<label class="form-label"> Lien Linkedin:</label>
									<input type="text" name="linkedin" class="form-control" placeholder="linkedin.com/in/sekaeric">
								</div>
                                <div class="mb-3">
								...
								<div class="mb-3">
									...
									<div>
										<label class="form-check form-check-inline">
											<input type="radio" class="form-check-input" value="1" name="publie" checked>
											<span class="form-check-label">Oui</span>
										</label>

										<label class="form-check form-check-inline">
											<input type="radio" class="form-check-input" value="0" name="publie">
