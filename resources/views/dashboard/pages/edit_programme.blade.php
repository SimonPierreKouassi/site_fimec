				...
				<div class="content">
					...
					<div class="card">
						<div class="card-header">
							<h5 class="mb-0">Modifier le programme</h5>
						</div>

						<div class="card-body">
							<div class="chart-container">
								 <div class="card-body">
		                	<form method="POST" action="{{ route('ajout_programmes.update', $programme->id) }}">
								@csrf
								<div class="row">
									...
									<div class="col-lg-10">
										<div class="row">
											<div class="col-lg-4">
												<div class="mb-3">
					                                <input type="text" value="{{ $programme->annee }}" name="annee" class="form-control" placeholder="Année">
				                                </div>
											...
											<div class="col-lg-8">
												<div class="mb-3">
					                                <input type="text" value="{{ $programme->lien_flip }}" name="lien_flip" class="form-control" placeholder="Lien">
				                                </div>
