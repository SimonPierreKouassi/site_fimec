...
<div class="content-inner">
					...
					<div class="page-header-content d-lg-flex">
						<div class="d-flex">
							<h4 class="page-title mb-0">
								Accueil - <span class="fw-normal">Dashboard</span>
							</h4>
				...
				<div class="navbar navbar-sm navbar-footer border-top">
					<div class="container-fluid">
						<span>&copy; 2026 Admin FIMEC </span>

						<ul class="nav">
							<li class="nav-item ms-md-1">
								<a href="general_faq.html" class="navbar-nav-link navbar-nav-link-icon rounded" target="_blank">
