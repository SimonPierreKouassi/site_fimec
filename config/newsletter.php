...
return [
     ...
     */
    'driver_arguments' => [
        // Prefer the `NEWSLETTER_*` variables but fall back to older `MAILCHIMP_*` names
        'api_key' => env('NEWSLETTER_API_KEY', env('MAILCHIMP_APIKEY')),

        'endpoint' => env('NEWSLETTER_ENDPOINT', env('MAILCHIMP_ENDPOINT')),
    ],
    ...
    'lists' => [
        ...
        'subscribers' => [
             ...
             */
            // Support both NEWSLETTER_LIST_ID and legacy MAILCHIMP_LIST_ID
            'id' => env('NEWSLETTER_LIST_ID', env('MAILCHIMP_LIST_ID')),
        ],
    ],
];
